...
class PySpeechServer:
    ...
    def addSentenceDictionary(self, arrSentences):
        for val in arrSentences:
            self.sentenceDictionary.append(val.lower())
    ...
    def fillCallbackUrls(self, sentenceToCallbackUrlsMap):
        for el in sentenceToCallbackUrlsMap:
            if el['sentence'].lower() not in self.callbackUrls:
                self.sentenceDictionary.append(el['sentence'].lower())
...
if __name__ == '__main__':
    ...
    print(speechServer.sentenceDictionary)
    print(speechServer.callbackUrls)
